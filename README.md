...
I built a small Active Directory lab built to simulate a basic enterprise IT environment using Windows Server 2022 and Windows 11 virtual machines. The goal was to gain hands-on experience with core IT support and systems administration tasks.
