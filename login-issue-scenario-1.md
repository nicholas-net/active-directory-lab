...
- `LAB/user1` is disabled the Active Directory Users and Computers

 <img width="2045" height="1303" alt="image" src="https://github.com/user-attachments/assets/2e3eff95-19a2-450a-bbc3-d73cabd16ed5" />


## Fix
- After using the Common Queries functionality in AD to locate the
- Right Click the disabled HR employees account and re-activate
<img width="2044" height="1300" alt="image" src="https://github.com/user-attachments/assets/540825c9-d3c3-4c12-9d0e-54708b5fa835" />
